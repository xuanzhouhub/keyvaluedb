...
This is a log-structured merge-tree (LSM-tree) key-value database engine developed from scratch by [Xuan Zhou](https://xuanzhouhub.github.io/xuanzhouhub/) using [OpenCode](https://github.com/anomalyco/opencode) V1.17 and [DeepSeek](https://github.com/deepseek-ai) V4 Pro. It is a fully functional engine with MVCC, WAL, lock free B+-tree MemTable, leveling SSTable, TCP server/client, range scans, prioritized batch writes and atomic compare-and-swap. C++17 is used for the implementation. It is fast.
